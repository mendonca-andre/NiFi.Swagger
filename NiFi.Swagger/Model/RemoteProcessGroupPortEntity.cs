...
namespace NiFi.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RemoteProcessGroupPortEntity :  IEquatable<RemoteProcessGroupPortEntity>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets RemoteProcessGroupPort
        /// </summary>
        [DataMember(Name="remoteProcessGroupPort", EmitDefaultValue=false)]
        public RemoteProcessGroupPortDTO RemoteProcessGroupPort { get; set; }
        ...
        {
            return this.Equals(input as RemoteProcessGroupPortEntity);
        }

        /// <summary>
        /// Returns true if RemoteProcessGroupPortEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoteProcessGroupPortEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoteProcessGroupPortEntity input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.RemoteProcessGroupPort == input.RemoteProcessGroupPort ||
                    (this.RemoteProcessGroupPort != null &&
                    this.RemoteProcessGroupPort.Equals(input.RemoteProcessGroupPort))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RemoteProcessGroupPort != null)
                    hashCode = hashCode * 59 + this.RemoteProcessGroupPort.GetHashCode();
