...
namespace NiFi.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProcessorRunStatusEntity :  IEquatable<ProcessorRunStatusEntity>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProcessorRunStatusEntity" /> class.
        /// </summary>
        ...
        /// <param name="state">The run status of the Processor..</param>
        ...
        public ProcessorRunStatusEntity(RevisionDTO revision = default(RevisionDTO), StateEnum? state = default(StateEnum?), bool? disconnectedNodeAcknowledged = default(bool?))
        {
        ...
        {
            return this.Equals(input as ProcessorRunStatusEntity);
        }

        /// <summary>
        /// Returns true if ProcessorRunStatusEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of ProcessorRunStatusEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProcessorRunStatusEntity input)
        {
            if (input == null)
                return false;
