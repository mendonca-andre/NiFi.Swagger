...
namespace NiFi.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FunnelDTO :  IEquatable<FunnelDTO>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as FunnelDTO);
        }

        /// <summary>
        /// Returns true if FunnelDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of FunnelDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FunnelDTO input)
        {
            if (input == null)
                return false;
