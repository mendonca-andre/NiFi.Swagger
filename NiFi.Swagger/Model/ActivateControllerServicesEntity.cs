...
namespace NiFi.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ActivateControllerServicesEntity :  IEquatable<ActivateControllerServicesEntity>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ActivateControllerServicesEntity" /> class.
        /// </summary>
        /// <param name="id">The id of the ProcessGroup.</param>
        /// <param name="state">The desired state of the descendant components.</param>
        /// <param name="components">Optional services to schedule. If not specified, all authorized descendant controller services will be used..</param>
        ...
        public ActivateControllerServicesEntity(string id = default(string), StateEnum? state = default(StateEnum?), Dictionary<string, RevisionDTO> components = default(Dictionary<string, RevisionDTO>), bool? disconnectedNodeAcknowledged = default(bool?))
        {
            this.Id = id;
            this.State = state;
        ...
        /// </summary>
        /// <value>Optional services to schedule. If not specified, all authorized descendant controller services will be used.</value>
        ...
        {
            return this.Equals(input as ActivateControllerServicesEntity);
        }

        /// <summary>
        /// Returns true if ActivateControllerServicesEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of ActivateControllerServicesEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActivateControllerServicesEntity input)
        {
            if (input == null)
                return false;
