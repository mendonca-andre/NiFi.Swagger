...
namespace NiFi.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProcessorEntity :  IEquatable<ProcessorEntity>, IValidatableObject
    {
        /// <summary>
        ...
        public ProcessorDTO Component { get; set; }
        ...
        public ProcessorStatusDTO Status { get; set; }
        ...
        {
            return this.Equals(input as ProcessorEntity);
        }

        /// <summary>
        /// Returns true if ProcessorEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of ProcessorEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProcessorEntity input)
        {
            if (input == null)
                return false;
