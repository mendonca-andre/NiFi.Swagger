...
namespace NiFi.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ControllerServiceReferencingComponentEntity :  IEquatable<ControllerServiceReferencingComponentEntity>, IValidatableObject
    {
        /// <summary>
        ...
        public ControllerServiceReferencingComponentDTO Component { get; set; }
        ...
        {
            return this.Equals(input as ControllerServiceReferencingComponentEntity);
        }

        /// <summary>
        /// Returns true if ControllerServiceReferencingComponentEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of ControllerServiceReferencingComponentEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ControllerServiceReferencingComponentEntity input)
        {
            if (input == null)
                return false;
