...
namespace NiFi.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RegistryClientEntity :  IEquatable<RegistryClientEntity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RegistryClientEntity" /> class.
        /// </summary>
        ...
        public RegistryDTO Component { get; set; }
        ...
        {
            return this.Equals(input as RegistryClientEntity);
        }

        /// <summary>
        /// Returns true if RegistryClientEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of RegistryClientEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RegistryClientEntity input)
        {
            if (input == null)
                return false;
