...
namespace NiFi.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NodeRemoteProcessGroupStatusSnapshotDTO :  IEquatable<NodeRemoteProcessGroupStatusSnapshotDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NodeRemoteProcessGroupStatusSnapshotDTO" /> class.
        /// </summary>
        ...
        /// <param name="statusSnapshot">The remote process group status snapshot from the node..</param>
        public NodeRemoteProcessGroupStatusSnapshotDTO(string nodeId = default(string), string address = default(string), int? apiPort = default(int?), RemoteProcessGroupStatusSnapshotDTO statusSnapshot = default(RemoteProcessGroupStatusSnapshotDTO))
        {
            this.NodeId = nodeId;
        ...
        /// </summary>
        /// <value>The remote process group status snapshot from the node.</value>
        [DataMember(Name="statusSnapshot", EmitDefaultValue=false)]
        public RemoteProcessGroupStatusSnapshotDTO StatusSnapshot { get; set; }
        ...
        {
            return this.Equals(input as NodeRemoteProcessGroupStatusSnapshotDTO);
        }

        /// <summary>
        /// Returns true if NodeRemoteProcessGroupStatusSnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of NodeRemoteProcessGroupStatusSnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NodeRemoteProcessGroupStatusSnapshotDTO input)
        {
            if (input == null)
                return false;
