...
namespace NiFi.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NodePortStatusSnapshotDTO :  IEquatable<NodePortStatusSnapshotDTO>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The port status snapshot from the node.</value>
        [DataMember(Name="statusSnapshot", EmitDefaultValue=false)]
        public PortStatusSnapshotDTO StatusSnapshot { get; set; }
        ...
        {
            return this.Equals(input as NodePortStatusSnapshotDTO);
        }

        /// <summary>
        /// Returns true if NodePortStatusSnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of NodePortStatusSnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NodePortStatusSnapshotDTO input)
        {
            if (input == null)
                return false;
