...
namespace NiFi.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserGroupEntity :  IEquatable<UserGroupEntity>, IValidatableObject
    {
        /// <summary>
        ...
        public UserGroupDTO Component { get; set; }
        ...
        {
            return this.Equals(input as UserGroupEntity);
        }

        /// <summary>
        /// Returns true if UserGroupEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of UserGroupEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserGroupEntity input)
        {
            if (input == null)
                return false;
