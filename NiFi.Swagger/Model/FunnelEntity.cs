...
namespace NiFi.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FunnelEntity :  IEquatable<FunnelEntity>, IValidatableObject
    {
        /// <summary>
        ...
        public FunnelDTO Component { get; set; }
        ...
        {
            return this.Equals(input as FunnelEntity);
        }

        /// <summary>
        /// Returns true if FunnelEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of FunnelEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FunnelEntity input)
        {
            if (input == null)
                return false;
