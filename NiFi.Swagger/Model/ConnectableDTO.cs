...
namespace NiFi.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConnectableDTO :  IEquatable<ConnectableDTO>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConnectableDTO" /> class.
        /// </summary>
        [JsonConstructor]
        protected ConnectableDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConnectableDTO" /> class.
        /// </summary>
        ...
        /// <param name="running">Reflects the current state of the connectable component..</param>
        /// <param name="transmitting">If the connectable component represents a remote port, indicates if the target is configured to transmit..</param>
        /// <param name="exists">If the connectable component represents a remote port, indicates if the target exists..</param>
        /// <param name="comments">The comments for the connectable component..</param>
        public ConnectableDTO(string id = default(string), string versionedComponentId = default(string), TypeEnum type = default(TypeEnum), string groupId = default(string), string name = default(string), bool? running = default(bool?), bool? transmitting = default(bool?), bool? exists = default(bool?), string comments = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ConnectableDTO and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ConnectableDTO and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (groupId == null)
            {
                throw new InvalidDataException("groupId is a required property for ConnectableDTO and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Reflects the current state of the connectable component.</value>
        ...
        /// </summary>
        /// <value>If the connectable component represents a remote port, indicates if the target is configured to transmit.</value>
        ...
        /// </summary>
        /// <value>If the connectable component represents a remote port, indicates if the target exists.</value>
        ...
        {
            return this.Equals(input as ConnectableDTO);
        }

        /// <summary>
        /// Returns true if ConnectableDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of ConnectableDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConnectableDTO input)
        {
            if (input == null)
                return false;
