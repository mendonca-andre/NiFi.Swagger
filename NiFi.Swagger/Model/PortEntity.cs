...
namespace NiFi.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PortEntity :  IEquatable<PortEntity>, IValidatableObject
    {
        /// <summary>
        ...
        public PortDTO Component { get; set; }
        ...
        {
            return this.Equals(input as PortEntity);
        }

        /// <summary>
        /// Returns true if PortEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of PortEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortEntity input)
        {
            if (input == null)
                return false;
