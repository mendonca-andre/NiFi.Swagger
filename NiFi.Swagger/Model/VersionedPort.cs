...
namespace NiFi.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VersionedPort :  IEquatable<VersionedPort>, IValidatableObject
    {
        /// <summary>
        /// The type of port.
        /// </summary>
        ...
        {
            return this.Equals(input as VersionedPort);
        }

        /// <summary>
        /// Returns true if VersionedPort instances are equal
        /// </summary>
        /// <param name="input">Instance of VersionedPort to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VersionedPort input)
        {
            if (input == null)
                return false;
