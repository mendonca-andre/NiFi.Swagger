...
namespace NiFi.Swagger.Model
{
    ...
    public partial class TenantDTO :  IEquatable<TenantDTO>, IValidatableObject
    {
        ...
        public TenantDTO(string id = default(string), string versionedComponentId = default(string), string parentGroupId = default(string), PositionDTO position = default(PositionDTO), string identity = default(string), bool? configurable = default(bool?))
        {
            this.Id = id;
