...
namespace NiFi.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NodeCountersSnapshotDTO :  IEquatable<NodeCountersSnapshotDTO>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The counters from the node.</value>
        [DataMember(Name="snapshot", EmitDefaultValue=false)]
        public CountersSnapshotDTO Snapshot { get; set; }
        ...
        {
            return this.Equals(input as NodeCountersSnapshotDTO);
        }

        /// <summary>
        /// Returns true if NodeCountersSnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of NodeCountersSnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NodeCountersSnapshotDTO input)
        {
            if (input == null)
                return false;
