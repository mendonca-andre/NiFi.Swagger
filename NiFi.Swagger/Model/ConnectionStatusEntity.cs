...
namespace NiFi.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConnectionStatusEntity :  IEquatable<ConnectionStatusEntity>, IValidatableObject
    {
        /// <summary>
        ...
        public ConnectionStatusDTO ConnectionStatus { get; set; }
        ...
        {
            return this.Equals(input as ConnectionStatusEntity);
        }

        /// <summary>
        /// Returns true if ConnectionStatusEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of ConnectionStatusEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConnectionStatusEntity input)
        {
            if (input == null)
                return false;
