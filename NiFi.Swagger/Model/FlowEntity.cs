...
namespace NiFi.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FlowEntity :  IEquatable<FlowEntity>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as FlowEntity);
        }

        /// <summary>
        /// Returns true if FlowEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of FlowEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlowEntity input)
        {
            if (input == null)
                return false;
