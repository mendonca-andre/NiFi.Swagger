...
namespace NiFi.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VersionedRemoteGroupPort :  IEquatable<VersionedRemoteGroupPort>, IValidatableObject
    {
        /// <summary>
        ...
        [DataMember(Name="remoteGroupId", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>The ID of the port on the target NiFi instance</value>
        ...
        {
            return this.Equals(input as VersionedRemoteGroupPort);
        }

        /// <summary>
        /// Returns true if VersionedRemoteGroupPort instances are equal
        /// </summary>
        /// <param name="input">Instance of VersionedRemoteGroupPort to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VersionedRemoteGroupPort input)
        {
            if (input == null)
                return false;
