...
namespace NiFi.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccessPolicyEntity :  IEquatable<AccessPolicyEntity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccessPolicyEntity" /> class.
        /// </summary>
        ...
        public AccessPolicyEntity(RevisionDTO revision = default(RevisionDTO), string id = default(string), string uri = default(string), PositionDTO position = default(PositionDTO), PermissionsDTO permissions = default(PermissionsDTO), List<BulletinEntity> bulletins = default(List<BulletinEntity>), bool? disconnectedNodeAcknowledged = default(bool?), string generated = default(string), AccessPolicyDTO component = default(AccessPolicyDTO))
        {
        ...
        public AccessPolicyDTO Component { get; set; }
        ...
        /// <summary>
        /// Returns true if AccessPolicyEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of AccessPolicyEntity to be compared</param>
        /// <returns>Boolean</returns>
