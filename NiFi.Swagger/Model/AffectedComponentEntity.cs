...
namespace NiFi.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AffectedComponentEntity :  IEquatable<AffectedComponentEntity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AffectedComponentEntity" /> class.
        /// </summary>
        ...
        public AffectedComponentDTO Component { get; set; }
        ...
        {
            return this.Equals(input as AffectedComponentEntity);
        }

        /// <summary>
        /// Returns true if AffectedComponentEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of AffectedComponentEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AffectedComponentEntity input)
        {
            if (input == null)
                return false;
