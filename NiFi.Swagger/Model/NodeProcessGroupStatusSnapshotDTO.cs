...
namespace NiFi.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NodeProcessGroupStatusSnapshotDTO :  IEquatable<NodeProcessGroupStatusSnapshotDTO>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The process group status snapshot from the node.</value>
        [DataMember(Name="statusSnapshot", EmitDefaultValue=false)]
        public ProcessGroupStatusSnapshotDTO StatusSnapshot { get; set; }
        ...
        {
            return this.Equals(input as NodeProcessGroupStatusSnapshotDTO);
        }

        /// <summary>
        /// Returns true if NodeProcessGroupStatusSnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of NodeProcessGroupStatusSnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NodeProcessGroupStatusSnapshotDTO input)
        {
            if (input == null)
                return false;
