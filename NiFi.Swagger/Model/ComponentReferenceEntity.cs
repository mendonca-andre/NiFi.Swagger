...
namespace NiFi.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComponentReferenceEntity :  IEquatable<ComponentReferenceEntity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComponentReferenceEntity" /> class.
        /// </summary>
        ...
        public ComponentReferenceEntity(RevisionDTO revision = default(RevisionDTO), string id = default(string), string uri = default(string), PositionDTO position = default(PositionDTO), PermissionsDTO permissions = default(PermissionsDTO), List<BulletinEntity> bulletins = default(List<BulletinEntity>), bool? disconnectedNodeAcknowledged = default(bool?), string parentGroupId = default(string), ComponentReferenceDTO component = default(ComponentReferenceDTO))
        {
        ...
        public ComponentReferenceDTO Component { get; set; }
        ...
        {
            return this.Equals(input as ComponentReferenceEntity);
        }

        /// <summary>
        /// Returns true if ComponentReferenceEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of ComponentReferenceEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComponentReferenceEntity input)
        {
            if (input == null)
                return false;
