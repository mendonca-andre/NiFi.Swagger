...
namespace NiFi.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccessPolicySummaryDTO :  IEquatable<AccessPolicySummaryDTO>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AccessPolicySummaryDTO);
        }

        /// <summary>
        /// Returns true if AccessPolicySummaryDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of AccessPolicySummaryDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccessPolicySummaryDTO input)
        {
            if (input == null)
                return false;
