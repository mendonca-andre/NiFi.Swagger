...
namespace NiFi.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PortRunStatusEntity :  IEquatable<PortRunStatusEntity>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PortRunStatusEntity" /> class.
        /// </summary>
        ...
        /// <param name="state">The run status of the Port..</param>
        ...
        public PortRunStatusEntity(RevisionDTO revision = default(RevisionDTO), StateEnum? state = default(StateEnum?), bool? disconnectedNodeAcknowledged = default(bool?))
        {
        ...
        {
            return this.Equals(input as PortRunStatusEntity);
        }

        /// <summary>
        /// Returns true if PortRunStatusEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of PortRunStatusEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortRunStatusEntity input)
        {
            if (input == null)
                return false;
