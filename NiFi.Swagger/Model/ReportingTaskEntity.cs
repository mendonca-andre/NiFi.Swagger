...
namespace NiFi.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReportingTaskEntity :  IEquatable<ReportingTaskEntity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportingTaskEntity" /> class.
        /// </summary>
        ...
        public ReportingTaskEntity(RevisionDTO revision = default(RevisionDTO), string id = default(string), string uri = default(string), PositionDTO position = default(PositionDTO), PermissionsDTO permissions = default(PermissionsDTO), List<BulletinEntity> bulletins = default(List<BulletinEntity>), bool? disconnectedNodeAcknowledged = default(bool?), ReportingTaskDTO component = default(ReportingTaskDTO), PermissionsDTO operatePermissions = default(PermissionsDTO))
        {
        ...
        public ReportingTaskDTO Component { get; set; }
        ...
        /// </summary>
        /// <value>The status for this ReportingTask.</value>
        [DataMember(Name="status", EmitDefaultValue=false)]
        public ReportingTaskStatusDTO Status { get; private set; }
        ...
        {
            return this.Equals(input as ReportingTaskEntity);
        }

        /// <summary>
        /// Returns true if ReportingTaskEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of ReportingTaskEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportingTaskEntity input)
        {
            if (input == null)
                return false;
