...
namespace NiFi.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccessPolicySummaryEntity :  IEquatable<AccessPolicySummaryEntity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccessPolicySummaryEntity" /> class.
        /// </summary>
        ...
        public AccessPolicySummaryEntity(RevisionDTO revision = default(RevisionDTO), string id = default(string), string uri = default(string), PositionDTO position = default(PositionDTO), PermissionsDTO permissions = default(PermissionsDTO), List<BulletinEntity> bulletins = default(List<BulletinEntity>), bool? disconnectedNodeAcknowledged = default(bool?), AccessPolicySummaryDTO component = default(AccessPolicySummaryDTO))
        {
        ...
        public AccessPolicySummaryDTO Component { get; set; }
        ...
        {
            return this.Equals(input as AccessPolicySummaryEntity);
        }

        /// <summary>
        /// Returns true if AccessPolicySummaryEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of AccessPolicySummaryEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccessPolicySummaryEntity input)
        {
            if (input == null)
                return false;
