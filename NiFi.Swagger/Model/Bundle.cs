...
namespace NiFi.Swagger.Model
{
    ...
    public partial class Bundle :  IEquatable<Bundle>, IValidatableObject
    {
        ...
        public Bundle(string group = default(string), string artifact = default(string), string version = default(string))
        {
            this.Group = group;
        ...
        {
            return this.Equals(input as Bundle);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(Bundle input)
        {
            if (input == null)
                return false;
